...
\documentclass[twocolumn,numbers]{april_aigc}
...
implementation, assemble a benchmark of 30 questions across infographic,
map, and scene modes, and evaluate the real-provider pipeline with automatic
completion checks, a strict visual-alignment gate, and a manual visible-hotspot
audit. Code, demos, and a live project page are publicly available.
}
