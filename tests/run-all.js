...
const commands = [
  ...
  ["node", ["--check", "server/sam3.js"]],
  ["node", ["--check", "server/image-cache.js"]],
  ...
  ["node", ["--check", "src/preview-strategy.js"]],
  ["node", ["--check", "src/app.js"]],
  ["node", ["--check", "tests/docs.test.js"]],
  ["node", ["--check", "tests/docs-demos.test.js"]],
  ["node", ["--check", "tests/docs-demo-interaction.test.js"]],
  ["node", ["--check", "tests/real-api-smoke.js"]],
  ["node", ["--check", "tests/real-browser-instance.js"]],
  ["node", ["--check", "tests/real-visual-acceptance.js"]],
  ["node", ["--check", "tests/preview-strategy.test.js"]],
  ...
  ["node", ["--check", "tests/locateanything-worker.test.js"]],
  ["node", ["--check", "tests/sam3.test.js"]],
  ...
  ["node", ["tests/preview-strategy.test.js"]],
  ["node", ["tests/api-adapter.test.js"]],
  ["node", ["tests/image-cache.test.js"]],
  ["node", ["tests/local-ocr.test.js"]],
  ["node", ["tests/locateanything.test.js"]],
  ["node", ["tests/locateanything-worker.test.js"]],
