...
const CASES = [
  ...
  {
    id: "zju-yuquan-mao-statue-scene",
    category: "scene",
    extraInstruction:
      "Use exactly six clickable modules with these exact titles: Mao Statue; Stone Pedestal; Front Lawn; Sunset Hillside; Left Tree Canopy; Right Tree Canopy. Match a real wide campus reference composition, not a symbolic monument poster: the upper half is open pink-purple sunset sky; Laohe Mountain is a continuous dark-green horizontal ridge across the upper middle; low academic buildings may appear only as subdued background context below the ridge; a dark mature tree belt sits directly behind the statue/pedestal, so the statue is backed by greenery rather than bare wall; the Mao Zedong statue is narrow and exactly centered on a tall dark gray stone pedestal; trees form two separated dark-green side masses with a lower, broken rear tree belt between them; the lower third is a broad, uninterrupted, dark-green front lawn with a quiet paved plaza around the pedestal. Keep the statue and pedestal modest in scale, similar to a distant campus photograph, but still clearly visible for segmentation. Create one refined painterly campus scene with clean object silhouettes: the Mao Statue is one continuous figure with no internal cutout holes and a pale outline against dark trees; the pedestal is one solid stone block directly below the statue and separated from lawn by paving; the front lawn is one continuous simple green foreground shape with a clean top edge; the Sunset Hillside is the distant ridge and warm sky backdrop; the left tree canopy is one single dark-green blob on the left; the right tree canopy is one separate dark-green blob on the right. The rear tree belt behind the statue should be visible but lower and visually secondary, with gaps so it does not fuse the left and right canopies into one giant shape. Do not add a seventh clickable target for the rear tree belt or background buildings; treat them as background context. Separate the six clickable shapes with visible sky, paving, grass, or tonal gaps. Do not create a campus map, flowchart, card grid, numbered pins, side legend, visible labels, foreground people, slogans, memorial text, invented building names, exact dates, or West Lake landmarks.",
    question:
      "Create a refined painterly scenic view matching a real wide reference composition of the Mao Zedong statue area at Zhejiang University Yuquan Campus: a distant, small standing Mao statue is centered on a tall stone pedestal, with a paved plaza and broad dark-green lawn in front, separate deep-green tree canopies on both sides plus a visible rear tree belt directly behind the statue, subdued campus buildings as background context, and Laohe Mountain under a large pink-purple sunset sky in the background. Fact anchors: Yuquan Campus is at 38 Zheda Road, Xihu District, Hangzhou; it backs onto Laohe Mountain; the campus has mature greenery and teaching-building surroundings. The only clickable targets are Mao Statue, Stone Pedestal, Front Lawn, Sunset Hillside, Left Tree Canopy, and Right Tree Canopy. Each clickable target should explain its visual role in the campus scene and its orientation value without inventing unsupported building names, gate names, slogans, exact dates, or map geometry."
  },
  {
